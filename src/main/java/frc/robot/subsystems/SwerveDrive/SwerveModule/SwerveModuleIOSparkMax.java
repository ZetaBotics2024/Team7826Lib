...
public class SwerveModuleIOSparkMax implements SwerveModuleIO{
    ...
    private void configDriveMotor(int driveMotorID, boolean driveMotorInverted) {
        ...
        this.driveMotor.setSmartCurrentLimit(SwerveModuleConstants.kDriveMotorMaxVoltage);
    ...
    private void configTurnMotor(int turnMotorID, boolean turnMotorInverted) {
        ...
        this.driveMotor.setSmartCurrentLimit(SwerveModuleConstants.kTurnMotorMaxVoltage);
    }
    ...
    public void updateInputs(SwerveModuleIOInputs inputs) {
        ...
        inputs.driveMotorDistanceMeters = (this.driveRelativeEncoder.getPosition() / SwerveModuleConstants.kDriveGearRatio) * SwerveModuleConstants.kWheelDistancePerRotation;
        ...
        double turnRelativeEncoderPositionRotations = this.turnRelativeEncoder.getPosition();
        inputs.turnMotorAbsolutePositionRotations = this.turnAbsoluteEncoder.getAbsolutePosition().getValueAsDouble();
        inputs.turnMotorRelitivePositionRotations = turnRelativeEncoderPositionRotations;
        inputs.wheelAngleRelitivePositionRotations = turnRelativeEncoderPositionRotations / SwerveModuleConstants.kTurningGearRatio;
